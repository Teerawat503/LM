...
export default function CreateCard() {
  ...
  const handleClickAdd = (
    ...
    if (!herbName || !description || !manufacturerTel || !imageUrl || !herbType || !benefits || !manufacturer || !usage) {
      ...
      <div className="container mx-auto p-4">
        ...
        <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-md">
          ...
          <div className="flex gap-4 mt-4">
            <button
              onClick={() =>
                handleClickAdd(herbName, description, manufacturerTel, imageUrl, herbType, benefits, manufacturer, usage)
              }
